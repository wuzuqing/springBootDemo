...
//		if ((!fileFileName.endsWith(IMAGE_TYPE_GIF) && !fileFileName.endsWith(IMAGE_TYPE_JPG)
//				&& !fileFileName.endsWith(IMAGE_TYPE_JPEG) && !fileFileName.endsWith(IMAGE_TYPE_BMP)
//				&& !fileFileName.endsWith(IMAGE_TYPE_PNG) && !fileFileName.endsWith(IMAGE_TYPE_PSD))) {
//			return false;
//		}
//		return true;
//	}
...
//					AffineTransform.getScaleInstance(height1 / height, width1 / width), null);
//			itemp = op.filter(bi, null);
//			ImageIO.write((BufferedImage) itemp, "JPEG", new File(result));
//		} catch (IOException e) {
//			e.printStackTrace();
...
//
//		// 方法一：按比例缩放（放大缩小）
//		ImageUtils.scale("d:/temp/222.png", "d:/temp/222_111.png", 4, false);// 测试OK
//
//		// 方法二：按高度和宽度缩放（放大缩小）
